...
resource "alicloud_arms_alert_robot" "default" {
  alert_robot_name = "example_value"
...
* `notify_type` - (Required) The type of the alert contact. Valid values: ARMS_CONTACT: contact. ARMS_CONTACT_GROUP: contact group. ARMS_ROBOT: robot.
